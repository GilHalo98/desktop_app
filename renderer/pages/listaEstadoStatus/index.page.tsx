...
import {
    ...
    RemoverEstadoStatus
} from '../../utils/API/interface/estadoStatus';
import {
    toggleModalRegistro,
    toggleModalOpciones,
...
import MenuRegistroEstadoStatus from './componentes/menuRegistroEstadoStatus';
...
export default function ListaEstadoStatusPage() {
            ...
            <main>
                ...
                <Container fluid>
                    ...
                    <Row>
                        <Col>
                            <Tabla
                                titulo={'Tabla de registros de estados de status'}
                                cabeceras={[
                                    'ID',
                                    'Nombre del estado de status',
                                    'Fecha de registro',
                            ...
                            >
                                ...
                                >
                                    <MenuModificarRegistro
                                        funcionModificarRegistro={(
                                            descripcionDeEstadoStatus: string
                                        ) => {
                                            modificarDato(
                                                refresh,
                                                idRegistroOperacion,
                                                descripcionDeEstadoStatus,
                                                ModificarEstadoStatus,
                                                setRefresh,
                                                () => {
                                                    toggleModalModificarRegistro(
                                ...
                                <BarraBusqueda
                                    tituloBoton='Buscar Estado de Status'
                                >
                                    <InputBusqueda
